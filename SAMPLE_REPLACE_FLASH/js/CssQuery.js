/*
 * [[ Update ]]
 * - CssQuery 함수는 Jindo에서 cssquery부분만 별도로 가져와서 사용중.
 */

// http://helloworld.naver.com/helloworld/1009
// http://jindo.dev.naver.com/docs/jindo/1.5.2.ajax.patch/ko/symbols/src/target_Jindo2-1.5.2.ajax.patch_ko_cssquery.js.html
// http://jindo.dev.naver.com/docs/jindo/1.5.2.ajax.patch/ko/symbols/_global_.html#cssquery
// http://dean.edwards.name/my/cssQuery/
// http://dean.edwards.name/my/cssQuery/test.html
 ...
 * @class
 * @description CssQuery() 함수(cssquery)는 CSS 선택자(CSS Selector)를 사용하여 객체를 탐색한다. CssQuery() 함수 대신 vw.utils.cssquery() 함수를 사용해도 된다. CSS 선택자로 사용할 수 있는 패턴은 표준 패턴과 비표준 패턴이 있다. 표준 패턴은 CSS Level3 명세서에 있는 패턴을 지원한다. 선택자의 패턴에 대한 설명은 다음 표와 See Also 항목을 참고한다.<br>
...
var vw;
if(!vw) vw = {};
if(vw.utils == undefined) vw.utils = {};

/**@namespace vw.utils.cssquery */ vw.utils.cssquery = (function() {
	/*
...
var CssQuery = vw.utils.cssquery;